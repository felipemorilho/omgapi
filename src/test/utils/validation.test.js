...
describe('Validation Class', () => {
    describe('validateName', () => {
        ...
        it('não deve validar um nome com menos de 3 caracteres', () => {
            ...
            expect(result).toEqual({
                valid: false,
                message: 'O nome deve ter entre 3 e 30 caracteres e conter apenas letras e números, sem iniciar com espaço.'
            });
        });

        it('não deve validar um nome com mais de 30 caracteres', () => {
            const result = Validation.validateName('testando o Limite de Caracteres Max');
            expect(result).toEqual({
                valid: false,
                message: 'O nome deve ter entre 3 e 30 caracteres e conter apenas letras e números, sem iniciar com espaço.'
            });
    ...
    describe('validatePrice', () => {
        ...
        it('não deve validar um preço que começa com zero', () => {
            ...
            expect(result).toEqual({
                valid: false,
                message: 'O preço deve ser um número positivo com até duas casas decimais e não pode começar com zero.'
            });
        });
